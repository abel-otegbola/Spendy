...
export default function BankingCard() {
  return (
    <div className="order-3 flex w-full max-w-[330px] flex-col gap-4 rounded-2xl border border-border/[0.5] bg-white dark:bg-[#101010] p-5 text-left shadow-[0_18px_50px_rgba(0,0,0,0.16)] absolute -right-26 scale-50 sm:top-[20px] top-[20px] sm:order-none sm:w-[260px] z-2">
